---
title: "Some particle filtering for Epidemiological Models"
...
using LowLevelParticleFilters, Plots, Random, Plots.Measures
Random.seed!(1234)
```
...
optf = OptimizationFunction(nll)
prob = OptimizationProblem(optf, θ0)
result = solve(prob, NelderMead(); callback, maxiters = 5)
```
